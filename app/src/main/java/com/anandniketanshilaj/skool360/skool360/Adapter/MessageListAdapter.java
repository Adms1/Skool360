...
import com.anandniketanshilaj.skool360.skool360.Activities.Spanable;
...
public class MessageListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            imageLoader.displayImage("http://103.8.216.132/" + principalModels.get(position).getImage(), profile_image);
    ...
    public static void makeTextViewResizable(final TextView tv, final int maxLine, final String expandText, final boolean viewMore) {
        ...
        vto.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                } else if (maxLine > 1 && tv.getLineCount() >= maxLine) {
